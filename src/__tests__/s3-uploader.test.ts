...
describe("s3-uploader", () => {
  ...
  describe("upload", () => {
    ...
    it("general", async () => {
      ...
      expect(calls.find((c) => c[0] === "some.json")[2]).toBe(
        "application/json"
      );
      expect(calls.find((c) => c[0] === "a.js")[2]).toBe(
        "application/javascript"
      );
      expect(calls.find((c) => c[0] === "a.css")[2]).toBe("text/css");
      expect(calls.find((c) => c[0] === "folder1/b.js")[2]).toBe(
        "application/javascript"
      );
      expect(calls.find((c) => c[0] === "folder1/b.css")[2]).toBe("text/css");
      expect(calls.find((c) => c[0] === "folder1/folder2/c.js")[2]).toBe(
        "application/javascript"
      );
      expect(calls.find((c) => c[0] === "folder1/folder2/c.css")[2]).toBe(
        "text/css"
      );
    });
  });
